...
<div class="app-main p-3">
    <h1 class="mb-4 mt-5">Tambah data motor</h1>
    ...
    <form action="{{ route('motors.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <textarea name="nama" id="nama" class="form-control" rows="3">{{ old('nama') }}</textarea>
        </div>

        <div class="mb-3">
            <label for="kategori" class="form-label">Keterangan</label>
            <textarea name="kategori" id="kategori" class="form-control" rows="3">{{ old('kategori') }}</textarea>
        </div>

        <div class="mb-3">
            <label for="harga" class="form-label">Harga</label>
            <textarea name="harga" id="harga" class="form-control" rows="3">{{ old('harga') }}</textarea>
        </div>
