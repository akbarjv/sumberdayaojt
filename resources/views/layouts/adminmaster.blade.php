...
<html lang="en">
  ...
  <head>
    ...
    <title>CodaRent | Dashboard</title>
    ...
    <meta name="title" content="CodaRent | Dashboard" />
    <meta name="author" content="ColorlibHQ" />
    <meta name="description" content="CodaRent." />
    <meta name="keywords"
  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="app-wrapper">
      ...
      @unless(View::hasSection('hideHeader') && View::getSection('hideHeader'))
      @include('layouts.addminheader')
      @endunless
